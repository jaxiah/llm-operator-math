...
- **Weight Tying**：Press & Wolf, *"Using the Output Embedding to Improve Language Models"*, EACL 2017
- **BPE 分词**：Sennrich et al., *"Neural Machine Translation of Rare Words with Subword Units"*, ACL 2016

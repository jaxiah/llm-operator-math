...
2020 年 10 月，Google Brain 发表了论文 *"An Image is Worth 16x16 Words"*，
...
- **ViT 论文**：Dosovitskiy et al., *"An Image is Worth 16x16 Words: Transformers for Image Recognition at Scale"*, ICLR 2021
- **3D 卷积**：Tran et al., *"Learning Spatiotemporal Features with 3D Convolutional Networks"* (C3D), ICCV 2015
- **Video ViT**：Arnab et al., *"ViViT: A Video Vision Transformer"*, ICCV 2021
- **Qwen2-VL 技术报告**：Wang et al., *"Qwen2-VL: Enhancing Vision-Language Model's Perception of the World at Any Resolution"*, 2024
